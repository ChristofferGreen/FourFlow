...
=========================================================================*/
// .NAME vtkFourFlowSAX -  select piece (e.g., volume of interest) and/or subsample structured dataset
// .SECTION Description
// vtkFourFlowSAX is a wrapper around vtkExtractVOI, vtkExtractGrid and
...
#ifndef __vtkFOURFLOWSAX_h
#define __vtkFOURFLOWSAX_h
...
class vtkFourFlowSAX : public vtkDataSetAlgorithm
{

public:
  static vtkFourFlowSAX *New();
  vtkTypeMacro(vtkFourFlowSAX,vtkDataSetAlgorithm);
  ...
  vtkGetVectorMacro(VOI,int,6);
	...
	int SAXPlane;
	void SetSAXPlane(int plane);
	int GetSAXPlane();

	vtkSetVector2Macro(PlaneRange, int);
	vtkGetVector2Macro(PlaneRange, int);	
...
private:
  vtkFourFlowSAX(const vtkFourFlowSAX&);  // Not implemented.
  void operator=(const vtkFourFlowSAX&);  // Not implemented.
};
