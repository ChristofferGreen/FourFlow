...
vtkFourFlowPlaneRepresentation::vtkFourFlowPlaneRepresentation() {
	...
	this->CornerMapper1->SetInputConnection(this->Corner1->GetOutputPort());
	...
	this->CornerMapper2->SetInputConnection(this->Corner2->GetOutputPort());
	...
	this->CornerMapper3->SetInputConnection(this->Corner3->GetOutputPort());
	...
	this->CornerMapper4->SetInputConnection(this->Corner4->GetOutputPort());
...
void vtkFourFlowPlaneRepresentation::InstantiateHandleRepresentation() {
	////std::cout<<"InstantiateHandleRepresentation"<<std::endl;
...
void vtkFourFlowPlaneRepresentation::StartWidgetInteraction(double e[2]) {
	////std::cout<<"StartWidgetInteraction"<<std::endl;
...
void vtkFourFlowPlaneRepresentation::WidgetInteraction(double e[2]) {
	////std::cout<<"WidgetInteraction"<<std::endl;
...
void vtkFourFlowPlaneRepresentation::PositionHandles() {
	////std::cout<<"PositionHandles"<<std::endl;
...
int vtkFourFlowPlaneRepresentation::ComputeInteractionState(int X, int Y, int vtkNotUsed(modify)) {
	////std::cout<<"ComputeInteractionState"<<std::endl;
	this->Picker->Pick(X,Y,0.0,this->Renderer);
	vtkAssemblyPath *path = this->Picker->GetPath();

	//std::cout << "this->InteractionStateaaa: " << this->InteractionState << std::endl;
	...
	////std::cout << "this->InteractionState: " << this->InteractionState << std::endl;
...
void vtkFourFlowPlaneRepresentation::TranslatePlane(double *p1, double *p2) { // Loop through all points and translate them
	////std::cout<<"TranslatePlane"<<std::endl;
...
void vtkFourFlowPlaneRepresentation::CreateDefaultProperties() {
	////std::cout<<"CreateDefaultProperties"<<std::endl;
  // Endpoint properties
...
int vtkFourFlowPlaneRepresentation::RenderOpaqueGeometry(vtkViewport *v) {
	////std::cout<<"RenderOpaqueGeometry"<<std::endl;
	int count=0;
	this->BuildRepresentation();
