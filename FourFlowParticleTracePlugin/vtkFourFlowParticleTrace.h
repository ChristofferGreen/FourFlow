#ifndef __vtkFourFlowParticleTrace_h
#define __vtkFourFlowParticleTrace_h
...
//BTX
namespace vtkFourFlowParticleTraceNamespace
{
...
class VTK_EXPORT vtkFourFlowParticleTrace : public vtkPolyDataAlgorithm
{
public:
  enum Solvers
  {
  ...
  static vtkFourFlowParticleTrace *New();

  vtkTypeMacro(vtkFourFlowParticleTrace,vtkPolyDataAlgorithm)
  ...
  void SetParticleReleaseStartFrame(int val);
  vtkGetMacro(ParticleReleaseStartFrame,int);
  int ParticleReleaseStartFrame;

  vtkGetMacro(IntegrationDirection,int);
  void SetIntegrationDirection(int val);
 ...
 protected:
  ...
  vtkFourFlowParticleTraceNamespace::ParticleDataList  ParticleHistories;
  ...
  vtkFourFlowParticleTrace();
  virtual ~vtkFourFlowParticleTrace();
  ...
  int OutputParticles(vtkPolyData* poly); //every iteration
  ...
  // number that passed
  void TestParticles(
    vtkFourFlowParticleTraceNamespace::ParticleVector &candidates,
    vtkFourFlowParticleTraceNamespace::ParticleVector &passed,
    int &count);

  void TestParticles(
    vtkFourFlowParticleTraceNamespace::ParticleVector &candidates, std::vector<int> &passed);
  ...
  void IntegrateParticle(
    vtkFourFlowParticleTraceNamespace::ParticleListIterator &it,
  ...
  virtual bool SendParticleToAnotherProcess(
    vtkFourFlowParticleTraceNamespace::ParticleInformation &,
    vtkFourFlowParticleTraceNamespace::ParticleInformation &, vtkPointData*)
  {
    return true;
  }
  ...
  void AddParticle(vtkFourFlowParticleTraceNamespace::ParticleInformation &info, double* velocity);
...
private:
  ...
  bool RetryWithPush(
    vtkFourFlowParticleTraceNamespace::ParticleInformation &info, double* point1,double delT, int subSteps);
...
private:
  ...
  vtkFourFlowParticleTraceNamespace::ParticleVector    LocalSeeds;
  ...
  vtkFourFlowParticleTrace(const vtkFourFlowParticleTrace&);  // Not implemented.
  void operator=(const vtkFourFlowParticleTrace&);  // Not implemented.
