...
//#include <vtkFourFlowEnsightReader.h>
...
VolumeSliceView::VolumeSliceView(const QString& viewmoduletype, const QString& group, const QString& name, 
 ...
 : pqView(viewmoduletype, group, name, viewmodule, server, p) {
	...
	/*Ui_probeResultsWindow *probeWindowUI = new Ui_probeResultsWindow();
	probeWindowUI->setupUi(this->VolumeSliceWidget);*/
    ...
    /*QIcon iconNetworkWirelessEncrypted;
    iconNetworkWirelessEncrypted.addFile(QString::fromUtf8(":/Icons/icons/polygoneditor.png"), QSize(), QIcon::Normal, QIcon::Off);
	QPushButton *polygonButton = new QPushButton(this->volumeSliceWidget);
    polygonButton->setObjectName(QString::fromUtf8("polygonButton"));
    polygonButton->setLayoutDirection(Qt::LeftToRight);
    polygonButton->setIcon(iconNetworkWirelessEncrypted);
    polygonButton->setIconSize(QSize(32, 32));
    polygonButton->setFlat(false);
	polygonButton->setGeometry(378, 0, 125, 40);
...
void VolumeSliceView::updated() {
	...
	if(polyData) {
		cout << "VolumeSliceView::updated " << polyData->GetMTime() << endl;
		this->setCurrentTime();
...
void VolumeSliceView::onRepresentationAdded(pqRepresentation* rep) {
	...
	QObject::connect(representation, SIGNAL(dataUpdated()), this, SLOT(updated()));
}
